            ...
            <div className="bg-[#171A1D] border border-[#3B3B40] rounded-xl w-full max-w-lg flex flex-col shadow-2xl" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="p-6 flex flex-col gap-4">       
                   <div className="flex flex-col gap-1">
                        ...
                        <label className="w-full h-24 border border-[#3B3B40] rounded-lg flex flex-col items-center justify-center text-sm text-[#C0C0C0] bg-[#0D0F11] cursor-pointer hover:bg-[#171A1D] transition-colors">
